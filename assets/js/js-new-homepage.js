...
//------------------------------	
	...
	jQuery(window).scroll(function(){            
		...
		if(jQuery(window).scrollTop() != 0){
			...
			jQuery('.logo2').stop().animate({width: '100px',marginTop: '10px'}, 100);
		}       
		else {
			 if ( jQueryiw < 992 ) {
				jQuery('.logo2').stop().animate({width: '150px',marginTop: '-5px'}, 100);	
			  }
			  else{
			   jQuery('.mtnav2').stop().animate({top: '30px'}, 500);
			   	jQuery('.logo2').stop().animate({width: '150px',marginTop: '-16px'}, 100);	
			  }
		...
		if(jQuery(window).scrollTop() < jQueryih){
			...
			if(jQuery(window).scrollTop() < 800){
				...
				jQuery('#logo_preta').removeClass('mostra-logo');
				jQuery('#logo_preta').addClass('esconde-logo');

				jQuery('#logo_branca').removeClass('esconde-logo');
				jQuery('#logo_branca').addClass('mostra-logo');				
			}
			if(jQuery(window).scrollTop() == 0){
			...
			if(jQuery(window).scrollTop() > jQueryih){
				...
				jQuery('#logo_branca').removeClass('mostra-logo');
				jQuery('#logo_branca').addClass('esconde-logo');

				jQuery('#logo_preta').removeClass('esconde-logo');
				jQuery('#logo_preta').addClass('mostra-logo');				
			}
			jQuery('.navbar-wrapper3').addClass('navbar-fixed-top2');
			jQuery('.navbar-fixed-top2').stop().animate({top: '0px'}, 500);
