					...
					<div class="tab-content5">
					  ...
					  <div class="tab-pane padding40 active" id="profile">
						  ...
						  <div class="col-md-4 offset-0">
							...
							<a href="#" class="lblue">Trocar foto?</a>
							</p>
							<div class="clearfix"></div>
						  </div>
						  <div class="col-md-4">
						...
						<form method="post" action="/praquerumo/usuarios/update">
							<!-- COL 1 -->
							<div class="form-group">
								...
								<br/>
								Telefone:
								<input type="text" name="telefone"  value="<?= $telefone ?>"class="form-control" placeholder="">	
