														...
														<div>
															<span style="color: rgb(0, 0, 0)"><span
																style="font-weight: bold"><font
																	...
																	style="font-size: 28px">Mais Informações para Cliente</font></span></span>
														</div>
													</td>
												</tr>
											</tbody>
											...
											<tbody>
												<tr>
													<td align="justify" valign="top"
														...
														<p>Olá,</p>
														<div>
															<p> Recebemos uma pergunta sobre sua atividade na plataforma, responda para nós assim que possível, para manter o cliente sempre interessado em sua atividade.</p>
															<div style="font-weight: bold;">
																<p>Dados do cliente:</p>
																<p style="border: 1px solid black;width: 100%;text-align: center;">
																	Nome: <?=$nome?><br/>
																	<!-- Email: <?=$email?><br/>
