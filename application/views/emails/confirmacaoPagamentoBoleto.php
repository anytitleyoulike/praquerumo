							...
							<table width="100%" height="100%">
								<tr>
									...
									<td valign="top" style="color:#808080;">
										<p style="margin-top:15px; margin-left:6px;"><strong>Valor unitário</strong>: R$ <?=$compra["preco"]?></p>
										...
										<p style="margin-top:15px; margin-left:6px;"><strong>Valor Total</strong>: R$ <?=$compra["total"]?></p>
									</td>
								</tr>
							</table>
						</td>
