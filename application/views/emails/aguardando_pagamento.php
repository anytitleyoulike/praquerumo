				...
				<tr>
					<td align="center" valign="top" style="padding: 0; margin: 0">
						<table cellspacing="0" cellpadding="0" border="0" align="center"
							width="597" style="width: 597px; background-color: #FFF;" class="bg-mail">
							<tbody>
														...
														<div>
															<span style="color: rgb(0, 0, 0)"><span
																style="font-weight: bold"><font
																	...
																	style="font-size: 28px">Aguardando Pagamento</font></span></span>
														</div>
													</td>
												</tr>
											</tbody>
											...
											<tbody>
												<tr>
													<td align="justify" valign="top"
														...
														<span
														style="font-family: Helvetica, Trebuchet, Arial, sans-serif; color: #4b4b4b; font-size: 18px; font-weight: normal"></span>
														<p>Olá <?=$nome?>,</p>
														<div>
															<p> Tomamos conhecimento de seu pedido por <b>BOLETO BANCÁRIO</b> e estamos felizes pelo seu interesse :) </p>
															<p>
																Você deve ter recebido sua fatura do <b>BOLETO</b> quando foi redirecionado através do nosso site. Por
gentileza, imprima a página referente ao boleto e leve-a com você para realizar o depósito. Você
pode efetuar o depósito na maioria dos bancos ou através do site de seu banco.
															</p>
															<p>É importante lembra-lo de que a fatura do <b>BOLETO</b> vale somente por 24 horas!</p>
															<p>Seu boleto pode ser visualizado facilmente aqui: <h3><a href="<?=$url?>">Clique aqui para visualizar sua fatura</a></h3></p>

															<p>Depois de realizar o depósito, pode levar até 1 dia útil para recebermos o seu depósito. Depois disso, enviaremos seu voucher para esse email.</p>
															<p>Caso tenha quaisquer perguntas, por gentileza não hesite em nos contactar pelo email
<b>contato@praquerumo.com.br.</b></p>
															<p>Atenciosamente,</p>

															<p>Equipe Pra Que Rumo.</p>
											...
											<tbody>
												<tr>
													<td align="left" valign="top"
														style="padding: 10px; margin: 0px"><table
...
<html>
	...
	<table width='640px' border='0'>
		<tr>
			<td align='left' ><img src='img/logo_pqr.png' style='margin-top:22px; margin-left:37px; margin-bottom:16px;'/></td>
			<td align='right' ><h5 style='margin-top:36px; margin-right:46px; color:#0CA86B;'>VENDA REALIZADA<br/>Data:00/00/2015</h5></td>
		</tr>
		<tr>
								...
								<tr>
									<td>
										<table>
											<tr>
												<td valign='top'>
													<img src='img/iconcebranco.png' width='25px' height='25px' style='margin-left:5px; margin-top:5px;'/>
												</td>
												<td>
													<p style='margin-top:15px; margin-left:6px; color:#FFF;'><strong>Atividade</strong>: bla-bla-bla-bla </p>
													<p style='margin-top:15px; margin-left:6px; color:#FFF;'><strong>Data</strong>: 00/00/2015</p>
													<p style='margin-top:15px; margin-left:6px; color:#FFF;'><strong>Hora</strong>: 00:00h</p>
												</td>
											</tr>
										</table>
									</td>
												...
												<table width='100%' height='100%'>
													<tr>
														<td valign='top' width='5%'>
															<img src='img/iconebranco2.png' width='25px' height='25px' style='margin-left:5px; margin-top:5px;'/>
														</td>
														<td valign='top'>
															<p style='margin-top:15px; margin-left:6px; color:#FFF;'><strong>Valor</strong>: R$ 00,00</p>
															<p style='margin-top:15px; margin-left:6px; color:#FFF;'><strong>Quantidade:</strong>: 00</p>
															<p style='margin-top:15px; margin-left:6px; color:#FFF;'><strong>Valor Total</strong>: R$ 00,00</p>
														</td>
													</tr>
												</table>
											</td>
				...
				<table width='557px' border='0' align='center'>
								...
								<tr>
									<td>
										<p style='margin-top:12px; color:#808080; font-size:12px;'>
											Você já deve ter recibo sua faturo do <strong>BOLETO</strong> quando foi redirecionado após a solicitação em
										...
										<p style='margin-top:12px; color:#808080; font-size:12px;'>
											É imporante lembrar que sua fatura pelo <strong>BOLETO</strong> vale somente por 24 horas!
										</p>
										<p style='margin-top:12px; color:#808080; font-size:12px;'>
					...
					<tr>
						<td align='center' colspan='2'>
							<a href='http://www.praquerumo.com.br'><img src='img/icone_sitepqr.png' width='30px' height='30px' /></a> 
							<a href='https://www.facebook.com/praquerumo'><img src='img/icone_facebook.png' width='30px' height='30px' /></a> 
							<a href='https://instagram.com/praquerumoficial/'><img src='img/icone_instagram.png' width='30px' height='30px' /></a> 
							<a href='https://plus.google.com/+PraquerumoBr'><img src='img/icone_googleplus.png' width='30px' height='30px' /></a> 
							<a href='https://twitter.com/PraQueRumo'><img src='img/icone_twitter.png' width='30px' height='30px' /></a> 
						</td>
					</tr>
				</table>
			</td>
