...
-- Generation Time: Aug 15, 2014 at 06:04 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Atividade que será anunciada' AUTO_INCREMENT=14 ;
...
(1, 'corredeiras-do-urubui', 0, 0, 0, NULL, NULL, 0, NULL, NULL, '', '', '', '', '', '', 1, 1, 0, 0),
(2, 'turismo-cientifico-na-amazonia', 0, 0, 0, NULL, NULL, 0, NULL, NULL, '', '', '', '', '', '', 2, 2, 0, 0),
(3, 'salto-do-ipy', 0, 0, 0, NULL, NULL, 0, NULL, NULL, '', '', '', '', '', '', 1, 2, 0, 0),
(4, '#fake1', 0, 0, 0, NULL, NULL, 0, NULL, NULL, '', '', '', '', '', '', 1, 1, 0, 0),
(5, '#fake2', 0, 0, 0, NULL, NULL, 0, NULL, NULL, '', '', '', '', '', '', 1, 1, 0, 0),
(6, '#fake3', 0, 0, 0, NULL, NULL, 0, NULL, NULL, '', '', '', '', '', '', 1, 1, 0, 0),
(7, '#fake4', 0, 0, 0, NULL, NULL, 0, NULL, NULL, '', '', '', '', '', '', 1, 1, 0, 0),
(8, '#fake5', 0, 0, 0, NULL, NULL, 0, NULL, NULL, '', '', '', '', '', '', 1, 1, 0, 0),
(9, 'sup-no-rio-taruma', 0, 0, 0, NULL, NULL, 0, NULL, NULL, '', '', '', '', '', '', 1, 1, 0, 0),
(10, 'lago-do-puraquequara', 0, 0, 0, NULL, NULL, 0, NULL, NULL, '', '', '', '', '', '', 1, 1, 0, 0),
(11, 'caiaque-em-rio-preto-da-eva', 0, 0, 0, NULL, NULL, 0, NULL, NULL, '', '', '', '', '', '', 1, 1, 0, 0),
(12, 'parque-de-aventura-ecoforest', 0, 0, 0, NULL, NULL, 0, NULL, NULL, '', '', '', '', '', '', 1, 2, 0, 0),
(13, 'expedicao-lago-janauari', 0, 0, 0, NULL, NULL, 0, NULL, NULL, '', '', '', '', '', '', 1, 1, 0, 0);
...
(1, 11, 5, 1, 'Incrível esse passeio no rio que dá nome ao município, sensacional!'),
...
(3, 13, 5, 1, 'Uma área verde enorme! A exuberância da natureza é incrível. Recomendo!'),
...
(14, 12, 5, 1, 'Foi top! Quero conhecer outras atividades por lá!');
...
(2, 11, 'Caiaque Rio Preto da Eva', 'The beauty and tranquility of the Amazon rivers are already waiting. Come feel the whole vibe of the forest for a walk in the calm waters of the Rio Preto da Eva.', 2, 2, 2, '<p>The Amazon Rainforest is imposing to any adventurer. The forest with your size, biological diversity, mysteries and their stories deserve much respect. But few know their enchantment their harmony and tranquility. To show you that side of unexplored forest, WR Locações company invites you to paddle through the calm waters of the rivers Rio Preto da Eva in a wonderful kayaking expedition.</p>', '', '', '', NULL, 'http://www.praquerumo.com.br/site/atividades/2014-08/?tribe-bar-date=2014-08&tribe-bar-search=Rio+Preto+da+Eva', NULL),
(2, 12, 'Arco e flecha com Canoagem', 'Saia da rotina e viva uma aventura em meio à selva amazônica com a prática de arco e flecha, trekking, slackline e canoagem.', 2, 2, 2, '<p>As atividades de aventura proporcionam momentos de valorização dos elementos essenciais da vida, podendo ser praticado por qualquer pessoa que queira fugir da rotina, superar desafios, explorar trajetos, contemplar a natureza.</p>\n<p>A Ecoforest Adventure uniu as modalidades de arco-flecha, slackline, canoagem e trekking proporcionando incríveis momentos de lazer e diversão.</p>\n<p>A prática de canoagem e trekking proporcionam momentos de integração e contemplação da natureza, sendo uma grande oportunidade de conhecer a floresta Amazônica e fugir da rotina. Arco e Flecha e slackline são esportes que lhe permite desenvolver a coordenação motora, a concentração e o equilíbrio físico. Auxilia também no combate ao stress, equilibrando assim a nossa mente e o nosso corpo. Além disso, é desafiador e super divertido.</p>', 'Manaus', 'AM', 'about 8hs', '<p>O local de encontro será no parque de aventura da Ecoforest Adventure, a apenas 39 quilômetros de Manaus, na rodovia BR-174 Km-923 (que antes era o Km-39).</p>\r\n<p>Inicialmente será dado instruções gerais de segurança e alongamento, daremos inicio as atividades com o trekking de 40min, ao final do trekking iremos iniciar a canoagem com um percurso de 500m. Em seguida será dado intervalo para descanso e almoço.</p>\r\n<p>No período da tarde serão realizadas instruções básicas para a prática de slackline e tiro com arco e será liberada a prática das atividades e acesso à nossa maravilhosa e refrescante área de banho.</p>\r\n\r\n<p>09:00-10:00 - Caminhada na selva</p>\r\n<p>10:00-11:00 – Instrução de Canoagem</p>\r\n<p>Tempo Livre</p>\r\n<p>14:00 – Instrução de Slackline</p>\r\n<p>15:00 – Instrução de Arco e flecha </p>\r\n<p>16:00- Retorno</p>', 'http://www.praquerumo.com.br/site/atividades/2014-08/?tribe-bar-date=2014-08&tribe-bar-search=Arco+e+Flecha+com+canoagem', NULL),
(2, 13, 'Expedição Lago Janauari', 'Uma remada em um dos mais famosos parques ecológicos da Amazônia, nos belos rios e exuberantes belezas naturais do lago Janauri.', 2, 2, 2, '<p>A Kayak Adventure vive essa experiência junto com você! </p>\n<p>Nosso objetivo é proporcionar condições e um clima favorável para que qualquer pessoa que goste de esporte e aventura sinta-se amparada e motivada a enfrentar o desafio de realizar uma travessia, sem a preocupação com o seu desempenho.</p>\n<p>A Remada com caiaque desenvolve sua espiritualidade, renova suas energias, transmite a mensagem da preservação dos rios e lagos, faz bem para o corpo, para mente e para alma, cultiva novas amizades e prepara cada um para sermos pessoas melhores, saudáveis, de bem com a vida e com o meio ambiente. Se você tem o espírito leve e não dispensa um aventura seja bem-vindo!</p>', 'Iranduba', 'AM', '5hrs', '<p>Juntos sairemos em comboio do município de Cacau Pirera até a entrada do ramal no km 7 da rodovia Manoel Urbano ( estrada de Manacapuru ) em seguida vamos por uma estrada de 20 km, até chegar a vila Janauarilândia, onde iniciaremos nossa expedição.</p>\n<p>Antes de partirmos, todos receberão orientação sobre a navegação em caiaque e alguns princípios básicos de segurança e conforto. Logo após, às 9hs em ponto partiremos para esse passeio único pelo exuberante Parque Ecológico do Janauari.</p>\n<p>O Parque Ecológico Janauari Com uma área de 9.000 ha, concentra vários ecossistemas da região. Possui matas de terra firme, de várzea e igápos (floresta inundada). Nesse roteiro A kayak Adventure leva você através da belezas naturais do lago com suas águas cristalinas, numa remada em grupo de aproximadamente 5km ao flutuante Ipixuna, onde existe um belo criatório de pirarucu ( peixe gigante da região ), ao igapó ( floresta inundada ) onde se encontra a rainha soberana da floresta - A Samaúma gigante, e durante o percurso a visualização da fauna e flora local como macacos, aves e outros animais habitantes da região.</p>\n<p>Se o tempo e as condições físicas do grupo permitirem, podemos nos estender por mais 4km, ao Lago de Vitórias-Régias - planta que abre sua folha redonda sobre as águas rasas e sem correnteza e chega a medir 1,8 m de diâmetro. No mesmo local encontram-se um flutuante restaurante e uma grande feira de artesanato flutuante mantida pelos moradores do lago onde o aventureiro pode adquirir uma lembrança em forma de arte.</p><p>-Concentração: 7:15hs no Centro de Atendimento ao Turista - CAT (Município de Iranduba/AM)</p>\n<p>-Partida para Janauarilândia: 08h00hs</p>\n<p>-Início da atividade com preleção: 09h00hs</p>\n<p>-Parada para lanche: 10h30 (local a definir)</p>\n<p>-Retorno: 13h</p>', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `esporte` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Esportes relacionados com a atividade = { caiaque, arvorismo' AUTO_INCREMENT=7 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Evento relacionado com a atividade' AUTO_INCREMENT=14 ;
...
(11, 11, '2014-07-27', '<p>Centro de Atendimento ao Turista - CAT à 79km de Manaus (estrada para Itacoatiara).</p><p>Horário de encontro: às 9hrs.</p>', 'Tourist Service Center - CAT at 79km from Manaus (road to Itacoatiara)', 0, 150.00, '-2.7001778', '-59.704727777777784', 1),
(12, 12, '2014-08-13', 'Av. Torquato Tapajós, em frente à Frigelo. Horário às 07:30hrs', 'Av. Torquato Tapajós, em frente à Frigelo. Horário 07:30hrs', 1, 60.00, '-3.0686111', '-60.02472222222222', 1),
(13, 13, '2014-08-13', 'Centro de Atendimento ao Turista - CAT (Município de Iranduba/AM). Endereço: Rodovia Manoel Urbano (AM-080) Km 2 à direita. ', 'Centro de Atendimento ao Turista - CAT (Município de Iranduba/AM). Endereço: Rodovia Manoel Urbano (AM-080) Km 2 à direita.', 1, 150.00, NULL, NULL, 1);
...
(12, 'Procure se hidratar', 'Hydrate yourself'),
(13, 'Levar roupa de banho', 'Take swimsuits'),
(14, 'Calça comprida', 'Wear pants'),
(15, 'Barraca ou rede', 'Tent camping or hammock'),
(16, 'Mochila impermeável pequena para seus pertences', 'Small waterproof bag for your belongings'),
(17, 'Óculos escuros, boné ou chapéu', 'Sunglasses, cap'),
(18, 'Maquina fotográfica, filmadora ou binóculos ( a prova d''água)', 'Camera, camcorder or binoculars (waterproof)'),
(19, 'Dê preferência por calças e camisas manga longa', 'Give preference for pants and long sleeve shirts');
...
(12, 'Lanche', 'Snack'),
(13, 'Acompanhamento fotográfico', 'photographic accompaniment'),
(14, 'Área para cozinhar', 'Area for cooking'),
(15, 'Não incluso alimentação', 'Feed not included'),
(16, 'Colete salva-vidas (uso obrigatório)', 'Lifejacket (Mandatory)'),
(17, 'Capacete de proteção individual (uso obrigatório)', 'Protective helmet (mandatory use)'),
(18, 'Caiaque individuais modelos ‘sit-on-top’ (abertos)', 'individual kayaks models ''sit-on-top'' (open)'),
(19, 'Assento e encosto confortável para o kayak', 'Seat and comfortable backrest for kayak'),
(20, 'Rádios de comunicação e Kit de primeiros socorros', 'Communication radios and first aid kit'),
(21, '', '');
...
(17, 'alce_nira@hotmail.com'),
(18, 'thayrinne.santos@hotmail.com'),
(19, 'renanbaima@gmail.com'),
(20, 'angelaraid@gmail.com');
...
(5, 2, 'wrlocacoes.eak@hotmail.com', '123', 'WR Locações', 20, NULL, NULL, '2014-06-26 00:00:00', '2014-06-26 00:00:00', NULL, NULL, 'Profissional com larga experiência nacional e internacional em Caiaques ', 'Profissional with large internacional experience in Kayak', NULL),
(7, 2, 'luniere_porto@hotmail.com', '123', 'Ecoforest Adventure', 20, NULL, NULL, '2014-06-26 00:00:00', '2014-06-26 00:00:00', 'Proporciona serviços de excelência no segmento de ecoturismo e turismo de aventura.', NULL, '', '', NULL),
(8, 2, 'jmacanoni@gmail.com', '123', 'Kayak Adventure', 20, '50874276268', '16642578000181', '2014-08-13 00:00:00', '2014-08-13 00:00:00', 'Empresa especializada em expedições, travessias, descidas de corredeiras nos Rios, lagos e igarapés da Região Amazônica fomentando o turismo de Aventura e o esporte aquático.', NULL, '', '', NULL);
...
(14, 'renanbaima@gmail.com', '', 'Renan', NULL, 'Manaus', 'AM', 'Brasil', '2014-06-22 00:00:00', '2014-06-22 00:00:00');
